...
IF("${CMAKE_COMPILER_IS_GNUCXX}" MATCHES "1")
    ...
    SET(WFC_CXX_STANDARD    "-std=c++0x")
    if ( NOT ${gcc_version_number} LESS 4008 )
      SET(WFC_CXX_STANDARD    "${WFC_CXX_STANDARD} -ftemplate-backtrace-limit=0")
    endif()
    ...
    SET(CMAKE_CXX_FLAGS       "${CXX_FLAGS} ${WFC_CXX_STANDARD} ${CMAKE_CXX_WARN_FLAGS} ${CMAKE_CXX_DEFINES} ${CMAKE_CXX_ARCH_FLAGS}")
