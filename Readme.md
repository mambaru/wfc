...
Большаяя часть функционала фремворка подключаеться в виде пакетов модулей. Из "коробки" [wfcroot](https://github.com/mambaru/wfcroot) вы получаете:
...
- [Поддержка JSON-RPC](https://github.com/mambaru/wfc_jsonrpc):
 ...
 Разбор параметров командной строки, демонизация, автоматический перезапуск с защитой от "кувыркания", 
