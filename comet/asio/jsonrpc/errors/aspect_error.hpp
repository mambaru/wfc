...
#include <comet/asio/jsonrpc/errors/ad_invalid_json.hpp>
#include <comet/asio/jsonrpc/errors/ad_send_error.hpp>
#include <comet/asio/jsonrpc/errors/ad_jsonrpc_error.hpp>
#include <comet/asio/jsonrpc/errors/ad_not_jsonrpc.hpp>
