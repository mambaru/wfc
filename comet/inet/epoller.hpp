...
#include <comet/inet/types.hpp>
#include <comet/inet/imux_observer.hpp>
...
protected:
  ...
  imux_observer *_reset_handler(desc_type d, imux_observer * , int event_falag)
  {
    imux_observer* oldHandler = 0;
